    ...
    <div class="mb-8">
        <div class="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0">
            ...
            <div class="flex space-x-2 sm:space-x-3">
                <button onclick="generateScript()" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center transition-colors" title="Generate Script">
                        ...
                        @foreach(Auth::user()->scripts()->latest()->take(10)->get() as $script)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <button onclick="viewScript('{{ $script->id }}')" class="text-indigo-600 hover:text-indigo-900">View</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
